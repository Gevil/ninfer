...
**Status as of 2026-09-09:** **V2-T1 has shipped** (branch `v2/t1-stream-kv` @ `ba21e676`, image tag `v2t1-ba21e676`); **V2-T2 is shipping** (branch `v2/t2-agentic` @ `0faef6d4`, tag `v2t2-0faef6d4` — pick 17 `adf494c2` only; picks 15,16 re-derived as superseded, §6.2); V2-T3…V2-T9 remain pending.
